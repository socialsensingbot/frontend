describe.only('#104 Slider and tweet interaction : https://github.com/socialsensingbot/frontend/issues/104',
    ...
    cy.moveMinDateSliderLeft(8);
                  ...
                  cy.url({timeout: 20000}).should("equal",
                                                  "http://localhost:4200/map?selected=greater%20london&max_time=1591100940000&min_time=1590755460000");
    ...
    cy.twitterPanelHeader("Greater London");
                  cy.tweetCountTotal(49);
                  cy.url({timeout: 20000}).should("equal",
                                                  "http://localhost:4200/map?selected=greater%20london&max_time=1591100940000&min_time=1591007520000");
