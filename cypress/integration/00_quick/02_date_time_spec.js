describe('02 Date time: ', function () {
  ...
  describe('select county and date range', () => {
    ...
    const url = "http://localhost:4200/map/live?selected=scottish%20borders&zoom=5&max_time=1539561540000&min_time=1539475200000&active_number=stats&active_polygon=county";
    it('with no tweets', () => {
      cy.visitAndWait(url);
