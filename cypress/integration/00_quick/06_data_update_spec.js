...
describe('Data Update: ', function () {
  describe('slider change', () => {
    ...
    it('after scheduled update', ()=> {
      ...
      cy.url().should("equal", "http://localhost:4200/map?abs_time=1587936900000&max_offset=0&min_offset=-1429")
      cy.stubLiveJson("live-long");
      cy.wait(65 * 1000);
      cy.get(".slider-date-time-max .slider-date").should("contain.text", "26-Apr-20");
      cy.get(".slider-date-time-max .slider-time").should("contain.text", "10 PM");
      cy.url().should("equal", "http://localhost:4200/map?abs_time=1588009140000&max_offset=-469&min_offset=-1909");
      cy.logout();
    });
