             ...
             describe('select county', () => {
                 ...
                 it('when unauthorized and load state', () => {
                     ...
                     cy.url({timeout: 30000}).should("equal",
                                                     MAP_URL + "?&active_number=exceedance&active_polygon=county&max_time=1631664000000&min_time=1631059200000&max_range_time=" + MAX_DATE_MILLIS + "&min_range_time=" + MIN_DATE_MILLIS);
                     cy.logout();
                 });
