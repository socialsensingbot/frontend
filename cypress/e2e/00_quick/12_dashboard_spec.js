import {ANALYTICS_URL, DASHBOARD_URL, MAP_URL} from "../../support/e2e";
...
describe('11 Analytics: ', function () {
    ...
    describe("Test Timeseries Graph", () => {
        ...
        it('Export from Analytics', () => {
            ...
            cy.wait(1000);
            cy.get(':nth-child(1) > .mat-card-content > app-timeseries-analytics-form > .ttc-form > .text-search').type(
                "everywhere");
            cy.get(":nth-child(1) > .mat-card-content > app-timeseries-analytics-form > .ttc-form > .region-chooser").type(
                "Card");
            cy.wait(1000);
            cy.get(".mat-option-text").click();
            ...
            cy.wait(10000);
            cy.get(
                "app-dashboard > div > mat-grid-list > div > mat-grid-tile:last-child > figure > mat-card .dashboard-card-title").should(
                "contain.text",
                title);
            ...
            cy.get(
                "app-dashboard > div > mat-grid-list > div > mat-grid-tile:last-child > figure > mat-card .dashboard-card-menu-btn").click();
            cy.wait(1000);
