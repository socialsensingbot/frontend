...
The quick tests are run during builds of feature and release branches and can be found in [integration/quick](/cypress/integration/quick), tests that are directly related to issues are in the [integration/quick/00_issues](/cypress/integration/quick/00_issues) folder and are prefixed with the issue id from GitHub.

The slow tests are run during builds of release branches (or manually) only and can be found in [integration/slow](/cypress/integration/slow), tests that are directly related to issues are in the [integration/slow/00_issues](/cypress/integration/slow/00_issues) folder and are prefixed with the issue id from GitHub. The difference is simply how long a test takes to run.
